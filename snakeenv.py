...
class CustomEnv(gym.Env):
    ...
    def step(self, action):
        ...
        self.apple_position[1]),(self.apple_position[0]+10,
    ...
    def reset(self):
        ...
        self.snake_head = [250,250]  #y,x , x and y are flipped in numpy opency

        self.prev_reward = 0
        self.done = False
        #head_x and head_y, apple_delta_x, apple_delta_y, snake_length, previous moves
        head_x = self.snake_head[0]
        head_y = self.snake_head[1]
